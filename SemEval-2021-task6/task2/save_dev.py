...
# 读取test data
training_file = "../data/dev_set_task2.txt"
def load_test_data():
    import sys
    import json
    try:
...
if __name__ == '__main__':
    ...
    for id in range(len(ids)):
        # 对于每一个句子
        path = './DataSet/dev_result/' + str(ids[id]) + '.csv'
    ...
    output_file = "./task2-dev_set-output.txt"
    output_labels = result
    dev_file = "../data/dev_set_task2.txt" # test数据地址
